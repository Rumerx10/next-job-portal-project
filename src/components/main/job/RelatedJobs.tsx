    ...
    <div>
      ...
      <div className="">
                ...
                <div className="text-gray-500 text-sm flex flex-col lg:flex-row justify-between lg:items-center">
                  <div className="flex flex-wrap gap-3 md:gap-5 items-center mb-3 lg:mb-0">
                    <div className="flex items-center gap-1">
                      <PiHandbagFill size={20} /> {category.orgName}
                    </div>
                    <div className="flex items-center gap-1">
                      <CiLocationOn size={20} /> {category.location}
                    </div>
                    <div className="flex items-center gap-1">
                      <MdOutlineAccessTime size={20} /> {category.createdAt}
                    </div>
                    <div className="flex items-center gap-1">
                      <BsCashCoin size={20} />
        ...
        <div className="flex w-full items-center justify-center mt-16">
          <button className="px-12 py-5 rounded-lg bg-primaryBlue text-white">
            Load More Listing
          </button>
        </div>
      </div>
