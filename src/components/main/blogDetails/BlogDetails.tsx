      ...
      <div className="w-full flex flex-col items-center justify-center py-10 lg:py-20">
        <div className="w-full flex flex-col items-center justify-center gap-10">
          <h1 className="w-full text-4xl font-bold text-center max-w-4xl">
            Attract Sales And Profits toward the sunshine - and shadows will
            fall behind you.
          </h1>
        ...
        <div className="max-w-7xl px-4 mx-auto w-full flex flex-col gap-5 mt-10">
          <div>
            ...
            <p>
              ...
              Curabitur this is a text link libero tempus congue.Duis mattis
              laoreet neque, et ornare neque sollicitudin at. Proin sagittis
              dolor sed mi elementum pretium. Donec et justo ante. Vivamus
              egestas sodales est, eu rhoncus urna semper eu. Come sociis
          ...
          <div className="flex flex-col lg:flex-row gap-3 justify-between border-y-2 py-5 lg:py-10">
            <div>
              <Link
                href="#"
                className="flex items-center gap-2 text-primaryBlue font-medium"
              >
                <IoIosArrowBack />
                <p>Previous Post</p>
              </Link>
            ...
            <div className="flex flex-col">
              <Link
                href="#"
                className="flex items-center lg:justify-end gap-2 text-primaryBlue font-medium"
              >
                <p>Next Post</p>
                <IoIosArrowForward />
              </Link>
              ...
              <div className="flex-1">
                <div>
                  ...
                  <p className="text-gray-700 mt-2 text-sm sm:text-base leading-relaxed">
                    Beautiful courses. Far much that one rank beheld bluebird
                    after outside ignobly allegedly more when oh arrogantly
                    vehement tantaneously eel valiantly petted this along across
                    highhandedly much.
                  </p>
                </div>
              </div>
