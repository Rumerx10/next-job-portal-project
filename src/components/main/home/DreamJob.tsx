      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="container max-auto flex flex-col items-center justify-center gap-2 lg:gap-5 text-white">
          ...
          >
            <Link
              href="#"
              className="px-10 py-3 rounded-lg whitespace-nowrap bg-[#e2eaf8] duration-300 cursor-pointer text-primaryBlue hover:text-white hover:bg-[#0146a6]"
            >
              Search Job
            </Link>
            <Link
              href="#"
              className="px-10 py-3 rounded-lg whitespace-nowrap bg-[#f9ab00] duration-300 cursor-pointer hover:bg-[#f9b700fd] text-white"
            >
              Search Job
            </Link>
          </motion.div>
