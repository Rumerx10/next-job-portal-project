  ...
  return (
    <div className="flex min-h-[900px] h-screen w-full">
      ...
      <div className="absolute flex items-center justify-center inset-0 top-20">
        <div className="flex flex-col gap-5 w-full max-w-7xl px-5 lg:px-10">
          <div className="flex justify-between items-center w-full gap-20 mt-40">
            <div className="text-white">
              <h1 className="text-3xl ld:text-5xl font-semibold">
              ...
              <form className="flex lg:hidden flex-col gap-5 rounded-md py-4">
                ...
                <div className="flex backdrop-blur-3xl bg-white/90 pl-8 pr-2 rounded-sm items-center text-black">
                  <SlLocationPin size={24} color="gray" />
                  <input
                    type="text"
                    placeholder="City or postcode"
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:items-center justify-between lg:mt-16">
