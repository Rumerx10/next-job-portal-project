      ...
      <div className="w-64 bg-white border-r border-gray-200 fixed h-full flex flex-col">
        ...
        <div className="flex-1 py-6 overflow-y-auto">
          <nav className="px-4 space-y-1">
            ...
            >
              <i
                className={`fas fa-chart-line mr-3 ${activePage === "dashboard" ? "text-indigo-600" : "text-gray-400"}`}
              ></i>
              Dashboard
            </button>
            <button
            ...
            >
              <i
                className={`fas fa-briefcase mr-3 ${activePage === "jobs" ? "text-indigo-600" : "text-gray-400"}`}
              ></i>
              Jobs
            </button>
            <button
            ...
            >
              <i
                className={`fas fa-file-alt mr-3 ${activePage === "applications" ? "text-indigo-600" : "text-gray-400"}`}
              ></i>
              Applications
            </button>
            <button
            ...
            >
              <i
                className={`fas fa-envelope mr-3 ${activePage === "messages" ? "text-indigo-600" : "text-gray-400"}`}
              ></i>
              Messages
            ...
            >
              <i
                className={`fas fa-cog mr-3 ${activePage === "settings" ? "text-indigo-600" : "text-gray-400"}`}
              ></i>
              Settings
            </button>
          </nav>
        ...
        <div className="p-4 border-t border-gray-200">
          <div className="flex items-center">
            <Avatar className="h-10 w-10 border border-gray-200">
              <AvatarImage
                src="https://readdy.ai/api/search-image?query=professional%20portrait%20photo%20of%20a%20young%20man%20with%20short%20brown%20hair%20wearing%20a%20business%20casual%20outfit%2C%20looking%20confident%20and%20approachable%2C%20high%20quality%20professional%20headshot%20on%20plain%20light%20background&width=100&height=100&seq=user-avatar&orientation=squarish"
                alt="User"
              />
                ...
                <CardContent className="space-y-4">
                  <div className="bg-indigo-50 border border-indigo-100 rounded-lg p-4">
                    ...
                    <div className="flex mt-3 space-x-2">
                      <Button
                        variant="default"
                        size="sm"
                        className="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white !rounded-button whitespace-nowrap"
                      >
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="flex mt-3 space-x-2">
                      ...
                      >
                        <i className="fas fa-directions mr-1"></i> Get
                        Directions
                      </Button>
                      <Button
                        variant="outline"
              ...
              <div className="flex space-x-6 pb-4">
                <Card className="w-80 flex-shrink-0">
                  ...
                  <CardFooter className="flex justify-between pt-0">
                    ...
                    <Button
                      size="sm"
                      className="bg-indigo-600 hover:bg-indigo-700 text-white !rounded-button whitespace-nowrap"
                    >
                      Quick Apply
                    </Button>
                  </CardFooter>
                ...
                <Card className="w-80 flex-shrink-0">
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-gray-500 mb-4">
                      Help build scalable cloud applications for millions of
                      customers worldwide.
                    </p>
                  </CardContent>
                  <CardFooter className="flex justify-between pt-0">
                ...
                <Card className="w-80 flex-shrink-0">
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-gray-500 mb-4">
                      Create beautiful, intuitive interfaces for Apple products
                ...
                <Card className="w-80 flex-shrink-0">
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-gray-500 mb-4">
                      Work on cutting-edge ML models to solve complex business
                      problems at scale.
                    </p>
                  </CardContent>
                  <CardFooter className="flex justify-between pt-0">
